...
@RunWith(Cucumber.class)
@CucumberOptions(features = { "src/test/resources/features" }, glue = { "de.frameworktsr.stepdefinitions",
        "de.frameworktsr.pages", "de.frameworktsr.hooks", "de.framweworktsr.utils" }, plugin = { "pretty",
                "html:target/reports/html-report.html",
                "json:target/reports/json-report.json" }, tags = "@RadionButtons")
// monochrome = true
// tags = {@popuMenu}
public class RunnerTest {
